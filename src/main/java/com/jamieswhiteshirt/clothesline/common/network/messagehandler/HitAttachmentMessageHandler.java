...
public class HitAttachmentMessageHandler implements BiConsumer<Context, HitAttachmentMessage> {
    @Override
    public void accept(Context ctx, HitAttachmentMessage message) {
